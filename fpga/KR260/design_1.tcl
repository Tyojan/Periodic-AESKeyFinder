...
\
  ...
  # Create instance: som_clk, and set properties
  set som_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 som_clk ]
  set_property -dict [list \
    CONFIG.AUTO_PRIMITIVE {MMCM} \
    CONFIG.CLKIN2_JITTER_PS {400.0} \
    CONFIG.CLKOUT1_DRIVES {Buffer} \
    CONFIG.CLKOUT1_JITTER {158.998} \
  ...
  set axi_ethernet_1_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_fifo_mm_s:4.3 axi_ethernet_1_fifo ]
  set_property -dict [list \
    CONFIG.C_AXIS_TUSER_WIDTH {4} \
    CONFIG.C_DATA_INTERFACE_TYPE {1} \
    CONFIG.C_HAS_AXIS_TKEEP {true} \
  ...
  if { [catch {set AESKeyFinder_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    CONFIG.C_AESKEYFINDER_SRC_ADDR {0x0800000000} \
  ] $AESKeyFinder_v1_0_0
  ...
  set_property -dict [list \
    CONFIG.ADVANCED_PROPERTIES {      __view__ { functional { S00_Buffer { R_SIZE 512 } M00_Buffer { R_SIZE 512 } } }     } \
    CONFIG.NUM_CLKS {2} \
    CONFIG.NUM_MI {2} \
    CONFIG.NUM_SI {1} \
  ] $smartconnect_1
  ...
  # Create instance: rst_ps_clk_0, and set properties
  set rst_ps_clk_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps_clk_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_JITTER {171.895} \
    CONFIG.CLKOUT1_MATCHED_ROUTING {true} \
    CONFIG.CLKOUT1_PHASE_ERROR {220.479} \
    ...
    CONFIG.FEEDBACK_SOURCE {FDBK_AUTO} \
    CONFIG.MMCM_BANDWIDTH {OPTIMIZED} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {47.500} \
  ...
  connect_bd_intf_net -intf_net AESKeyFinder_v1_0_0_m00_axi1 [get_bd_intf_pins smartconnect_1/S00_AXI] [get_bd_intf_pins AESKeyFinder_v1_0_0/m00_axi]
connect_bd_intf_net -intf_net [get_bd_intf_nets AESKeyFinder_v1_0_0_m00_axi1] [get_bd_intf_pins smartconnect_1/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets AESKeyFinder_v1_0_0_m00_axi1]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /AESKeyFinder_v1_0_0_m00_axi1]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_1_fifo_AXI_STR_TXC [get_bd_intf_pins axi_ethernet_1_fifo/AXI_STR_TXC] [get_bd_intf_pins axi_ethernet_1/s_axis_txc]
  connect_bd_intf_net -intf_net axi_ethernet_1_fifo_AXI_STR_TXD [get_bd_intf_pins axi_ethernet_1_fifo/AXI_STR_TXD] [get_bd_intf_pins axi_ethernet_1/s_axis_txd]
  connect_bd_intf_net -intf_net axi_ethernet_1_m_axis_rxd [get_bd_intf_pins axi_ethernet_1_fifo/AXI_STR_RXD] [get_bd_intf_pins axi_ethernet_1/m_axis_rxd]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins AESKeyFinder_v1_0_0/s00_axi] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins axi_ethernet_1/s_axi] [get_bd_intf_pins smartconnect_0/M02_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins axi_ethernet_1_fifo/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_pins smartconnect_0/M06_AXI] [get_bd_intf_pins axi_ethernet_0_fifo/S_AXI_FULL]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins smartconnect_0/S01_AXI] [get_bd_intf_pins smartconnect_1/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M02_AXI [get_bd_intf_pins smartconnect_0/M05_AXI] [get_bd_intf_pins axi_ethernet_1_fifo/S_AXI_FULL]
  ...
  connect_bd_net -net axi_ethernet_0_refclk_clk_out2 [get_bd_pins som_clk/clk_out2] [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins axi_ethernet_1/gtx_clk]
  connect_bd_net -net axi_ethernet_1_fifo_mm2s_cntrl_reset_out_n [get_bd_pins axi_ethernet_1_fifo/mm2s_cntrl_reset_out_n] [get_bd_pins axi_ethernet_1/axi_txc_arstn]
  connect_bd_net -net axi_ethernet_1_fifo_mm2s_prmry_reset_out_n [get_bd_pins axi_ethernet_1_fifo/mm2s_prmry_reset_out_n] [get_bd_pins axi_ethernet_1/axi_txd_arstn]
  connect_bd_net -net axi_ethernet_1_fifo_s2mm_prmry_reset_out_n [get_bd_pins axi_ethernet_1_fifo/s2mm_prmry_reset_out_n] [get_bd_pins axi_ethernet_1/axi_rxd_arstn] [get_bd_pins axi_ethernet_1/axi_rxs_arstn]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins util_ds_buf_0/BUFG_I] [get_bd_pins AESKeyFinder_v1_0_0/axi_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins AESKeyFinder_v1_0_0/axi_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net rst_ps_clk_0_interconnect_aresetn [get_bd_pins rst_ps_clk_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_ps_clk_0_peripheral_aresetn [get_bd_pins rst_ps_clk_0/peripheral_aresetn] [get_bd_pins axi_ethernet_0_fifo/s_axi_aresetn] [get_bd_pins axi_ethernet_1_fifo/s_axi_aresetn] [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins proc_sys_reset_0/aux_reset_in]
  connect_bd_net -net som240_1_connector_hpa_clk0p_clk_1 [get_bd_ports som240_1_connector_hpa_clk0p_clk] [get_bd_pins som_clk/clk_in1]
  ...
  connect_bd_net -net som_clk_clk_out1 [get_bd_pins som_clk/clk_out1] [get_bd_pins axi_ethernet_0/ref_clk]
  connect_bd_net -net som_clk_clk_out3 [get_bd_pins util_ds_buf_0/BUFG_O] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins smartconnect_1/aclk1] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_1/s_axi_lite_clk] [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins axi_ethernet_0_fifo/s_axi_aclk] [get_bd_pins axi_ethernet_1_fifo/s_axi_aclk] [get_bd_pins rst_ps_clk_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins smartconnect_0/aclk1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins rst_ps_clk_0/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AESKeyFinder_v1_0_0/s00_axi/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg0] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_ethernet_0_fifo/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_ethernet_1/s_axi/Reg0] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_ethernet_1_fifo/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs axi_ethernet_0_fifo/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs axi_ethernet_0_fifo/S_AXI_FULL/Mem1] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs axi_ethernet_1_fifo/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs axi_ethernet_1_fifo/S_AXI_FULL/Mem1] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs AESKeyFinder_v1_0_0/s00_axi/reg0]
  exclude_bd_addr_seg -offset 0xA0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg0]
  exclude_bd_addr_seg -offset 0xA0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs axi_ethernet_1/s_axi/Reg0]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces AESKeyFinder_v1_0_0/m00_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI]
  exclude_bd_addr_seg -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_ethernet_0_fifo/S_AXI_FULL/Mem1]
  exclude_bd_addr_seg -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_ethernet_1_fifo/S_AXI_FULL/Mem1]
